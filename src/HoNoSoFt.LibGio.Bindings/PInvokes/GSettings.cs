...
namespace HoNoSoFt.LibGio.Bindings.PInvokes
{
    ...
    {
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_new")]
        public static extern IntPtr New(string schema);
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_new_with_path")]
        public static extern IntPtr New(string schema, string path);
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_sync")]
        public static extern void Sync();
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_get_value")]
        public static extern IntPtr GetValue(IntPtr settings, string key);
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_set_value")]
        public static extern bool SetValue(IntPtr settings, string key, IntPtr value);
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_is_writable")]
        public static extern bool IsWritable(IntPtr settings, string key);
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_delay")]

        public static extern void Delay(IntPtr settings);
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_apply")]
        public static extern void Apply(IntPtr settings);
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_revert")]
        public static extern void Revert(IntPtr settings);
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_get_has_unapplied")]
        public static extern bool HasUnApplied(IntPtr settings);

        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_get_child")]
        public static extern IntPtr GetChild(IntPtr settings, string childSchemaName);

        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_reset")]
        public static extern void Reset(IntPtr settings, string key);
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_get_user_value")]
        public static extern IntPtr GetUserValue(IntPtr settings, string key);
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_get_default_value")]
        ...
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_list_schemas")]
        ...
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_list_relocatable_schemas")]
        ...
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_list_keys")]
        public static extern IntPtr ListKeys(IntPtr settings);

        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_list_children")]
        ...
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_get_range")]
        ...
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_get_flags")]
        public static extern uint GetFlags(IntPtr settings, string key);
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_set_flags")]
        public static extern bool SetFlags(IntPtr settings, string key, uint value);

        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_create_action")]
