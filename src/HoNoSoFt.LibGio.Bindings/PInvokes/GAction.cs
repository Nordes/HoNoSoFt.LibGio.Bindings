...
namespace HoNoSoFt.LibGio.Bindings.PInvokes
{
    internal static class GAction
    {
        ...
        [DllImport("libgio-2.0.so", EntryPoint = "g_action_print_detailed_name")]
