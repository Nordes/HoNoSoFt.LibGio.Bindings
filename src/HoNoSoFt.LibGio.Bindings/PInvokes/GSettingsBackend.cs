...
namespace HoNoSoFt.LibGio.Bindings.PInvokes
{
    internal static class GSettingsBackend
    {
        ...
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_null_settings_backend_new")]
