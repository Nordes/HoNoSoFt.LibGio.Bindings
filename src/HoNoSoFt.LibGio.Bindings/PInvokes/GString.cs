...
namespace HoNoSoFt.LibGio.Bindings.PInvokes
{
    ...
    {
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_string_new")]
        public static extern IntPtr New(string str);

        [DllImport("libgio-2.0.so.0", EntryPoint = "g_string_assign")]
        public static extern IntPtr Assign(IntPtr gString, string str);
        //g_string_vprintf
        //g_string_append_vprintf
        //g_string_printf
        //g_string_append_printf
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_string_append")]
        ...
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_string_prepend")]
        public static extern IntPtr Prepend(IntPtr gString, string str);
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_string_prepend_c")]
        ...
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_string_free")]
