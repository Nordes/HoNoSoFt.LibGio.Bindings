...
namespace HoNoSoFt.LibGio.Bindings.PInvokes
{
    ...
    {
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_new_boolean")]
        public static extern IntPtr NewBoolean(bool value);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_new_byte")]
        public static extern IntPtr NewByte(byte value);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_new_int16")]
        public static extern IntPtr NewInt16(short value);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_new_int32")]
        public static extern IntPtr NewInt(int value);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_new_uint32")]
        public static extern IntPtr NewUInt(uint value);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_new_int64")]
        public static extern IntPtr NewInt64(long value);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_new_uint64")]
        public static extern IntPtr NewUInt64(ulong value);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_new_double")]
        public static extern IntPtr NewDouble(double value);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_new_string")]
        public static extern IntPtr NewString(string value);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_new_variant")]
        ...
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_is_object_path")]
        public static extern bool IsObjectPath(string objectPath);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_is_signature")]
        public static extern bool IsSignature(string objectPath);

        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_get_boolean")]
        public static extern bool GetBoolean(IntPtr gVariant);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_get_byte")]
        public static extern byte GetByte(IntPtr gVariant);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_get_int16")]
        public static extern short GetInt16(IntPtr gVariant);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_get_uint16")]
        public static extern ushort GetUInt16(IntPtr gVariant);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_get_int32")]
        public static extern int GetInt(IntPtr gVariant);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_get_uint32")]
        public static extern uint GetUInt(IntPtr gVariant);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_get_int64")]
        public static extern long GetInt64(IntPtr gVariant);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_get_uint64")]
        public static extern ulong GetUInt64(IntPtr gVariant);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_get_handle")]
        public static extern int GetHandle(IntPtr gVariant);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_get_double")]
        public static extern double GetDouble(IntPtr gVariant);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_get_string")]
        ...
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_dup_string")]
        public static extern string DupString(IntPtr gVariant, IntPtr size);
        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_get_variant")]
        public static extern IntPtr GetVariant(IntPtr gVariant);

        [DllImport("libgio-2.0.so", EntryPoint = "g_variant_print_string")]
