...
namespace HoNoSoFt.LibGio.Bindings.PInvokes
{
    ...
    {
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_schema_source_get_default")]
        public static extern IntPtr GetDefault();

        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_schema_source_ref")]
        public static extern IntPtr Ref(IntPtr gSettingsSchemaSource);

        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_schema_source_unref")]
        public static extern void UnRef(IntPtr gSettingsSchemaSource);

        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_schema_source_new_from_directory")]
        public static extern IntPtr NewFromDirectory(string directory, IntPtr parentSchemaSource, bool trusted, out IntPtr error);

        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_schema_source_list_schemas")]
        ...
        [DllImport("libgio-2.0.so.0", EntryPoint = "g_settings_schema_source_lookup")]
